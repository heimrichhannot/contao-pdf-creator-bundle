...
//            'reference' => $GLOBALS['TL_LANG']['tl_pdf_creator_config'],
            'options_callback' => [\Heimrichhannot\ContaoPdfCreatorBundle\DataContainer\PdfCreatorConfigContainer::class, 'onTypeOptionsCallback'],
            'eval' => [
...
//            'reference' => $GLOBALS['TL_LANG']['tl_pdf_creator_config'],
        ...
        'outputMode' => [
            ...
            'sorting' => false,
//            'reference' => $GLOBALS['TL_LANG']['tl_pdf_creator_config'],
            'options_callback' => [\Heimrichhannot\ContaoPdfCreatorBundle\DataContainer\PdfCreatorConfigContainer::class, 'onOutputModeOptionsCallback'],
            'eval' => [
                'includeBlankOption' => false,
                'tl_class' => 'w50',
            ],
